...
import { RECEBER_HDL32P, RES_IDENTIF_HDL32P, STATUS_HEARTBEAT_HDL32P, } from './capturas-reais.js';
/**
...
describe('capturas-reais — frames capturados da HDL32p', () => {
    ...
    it('o dump abre com PROG central (0x01) e fecha com PROG_FIM (0xfe)', () => {
        ...
        expect(RECEBER_HDL32P[RECEBER_HDL32P.length - 1][3]).toBe(ProgramacaoPABX.PROG_FIM);
    });
});
function hex(bytes) {
    return bytes.map((b) => b.toString(16).padStart(2, '0')).join(' ');
}
//# sourceMappingURL=capturas-reais.test.js.map